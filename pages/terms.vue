<template>
    <div class="pt-12">
        <div class="p-12  mx-auto">
            <div id="TOS" class="rounded-t-lg p-8 text-gray-900" style="background: hsla(0, 0%, 100%, 0.8); backdrop-filter: blur(30px);">
                    ...
                    <div class="container max-width-adaptive-sm">
                        <div class="text-component line-height-lg v-space-md">
                            <p>
                                ...
                                of {{ companyName }}'s Website, located at {{ companySite }}.
                            </p>
                            <p>
                                By accessing this website we assume you accept these terms and
                                conditions. Do not continue to use {{ companySite }} if you do not
                            ...
                            <p>
                                We employ the use of cookies. By accessing {{ companySite }}, you
                                agreed to use cookies in agreement with the {{ companyName }}'s
                                Privacy Policy.
                            </p>
                            <p>
                            ...
                            <p>
                                Unless otherwise stated, {{ companySite }} and/or its licensors
                                own the intellectual property rights for all material on
                                {{ companySite }}. All intellectual property rights are reserved.
                                You may access this from {{ companySite }} for your own personal
                                use subjected to restrictions set in these terms and conditions.
                            </p>
                            <p>You must not:</p>
                            <ul>
                                <li>Republish material from {{ companySite }}</li>
                                <li>Sell, rent or sub-license material from {{ companySite }}</li>
                                <li>
                                    Reproduce, duplicate or copy material from {{ companySite }}
                                </li>
                                <li>Redistribute content from {{ companySite }}</li>
                            </ul>
                            <p>This Agreement shall begin on the date hereof.</p>
                            <p>
                                Parts of this website offer an opportunity for users to post and
                                exchange opinions and information in certain areas of the website.
                                {{ companySite }} does not filter, edit, publish or review
                                Comments prior to their presence on the website. Comments do not reflect
                                the views and opinions of {{ companySite }},its agents and/or
                                ...
                                laws, {{ companySite }} shall not be liable for the Comments or
                            ...
                            <p>
                                {{ companyName }} reserves the right to monitor all Comments and
                            ...
                            <p>
                                You hereby grant {{ companySite }} a non-exclusive license to use,
                            ...
                            <p>
                                ...
                                the hyperlink compensates the absence of {{ companySite }}; and
                            ...
                            <p>
                                ...
                                e-mail to {{ companyEmail }}. Please include your name, your
                            ...
                            <p>
                                No use of {{ companySite }}'s logo or other artwork will be
...
<script setup>
    const companyName = 'A. V. SOLUTIONS'
    const companySite = 'avsolutions-india.com'
    const companyEmail = 'admin@avsolutions-india.com'
