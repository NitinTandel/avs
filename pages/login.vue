...
<div class="pt-24">
  <div class="p-8 lg:w-1/2 mx-auto">
    <div class="bg-white rounded-t-lg p-8" style="background: hsla(0, 0%, 100%, 0.8); backdrop-filter: blur(30px);">
    ...
    <div class="bg-gray-100 rounded-b-lg py-12 px-4 lg:px-24" style="background: hsla(0, 0%, 100%, 0.8); backdrop-filter: blur(30px);">
